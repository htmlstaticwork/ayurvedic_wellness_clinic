    ...
    if (cart.length === 0) {
        container.innerHTML = `
            <div class="text-center py-5 reveal">
                ...
                <h2 class="mb-3">Your health basket is empty</h2>
                <p class="text-secondary mb-5 mx-auto" style="max-width: 480px;">A balanced journey begins with conscious choices. Explore our remedies to find what suits your dosha constitution.</p>
                <a href="shop.html" class="btn btn-outline" style="padding: 1rem 3rem;">View All Products</a>
            </div>
        `;
        // Keep order summary but set to zero
